    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData.containsKey('data')) {
          ...
          return data.map((json) => TugasFrasa.fromJson(json)).toList();
        } else {
          return [];
        }
      } else {
        throw Exception('Failed to load tugas frasa: ${response.statusCode}');
      }
    } catch (e) {
      print('API Error: $e');
