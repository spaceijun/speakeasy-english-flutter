...
class JawabanTugas {
  ...
  final Map<String, dynamic>? tugasIdiom;

  JawabanTugas({
    required this.id,
    required this.tugasIdiomId,
  ...
  factory JawabanTugas.fromJson(Map<String, dynamic> json) {
    return JawabanTugas(
      ...
      tugasIdiomId: _parseToInt(json['tugas_idiom_id']) ?? 0,
      ...
      tugasIdiom:
          json['tugas_idiom'] != null
              ? (json['tugas_idiom'] is Map
                  ? Map<String, dynamic>.from(json['tugas_idiom'])
                  : null)
              : null,
    );
  }
...
class JawabanIdiom extends StatefulWidget {
  const JawabanIdiom({Key? key}) : super(key: key);

  @override
  State<JawabanIdiom> createState() => _DataJawabanPageState();
}

class _DataJawabanPageState extends State<JawabanIdiom> {
  ...
  Future<List<JawabanTugas>> _fetchJawabanTugas() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
          'https://speakeasy-english.web.id/api/jawaban-idioms/user/$userId',
        ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Padding(
                            ...
                            child: Text(
                              'Anda belum mengerjakan tugas idiom apapun',
                              textAlign: TextAlign.center,
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final String tugasTitle =
                          jawaban.tugasIdiom != null
                              ? 'Tugas Idiom ${jawaban.tugasIdiom!['id']}'
                              : 'Tugas Idiom ${jawaban.tugasIdiomId}';
