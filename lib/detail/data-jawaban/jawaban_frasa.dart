...
class JawabanTugas {
  ...
  final Map<String, dynamic>? tugasFrasa;

  JawabanTugas({
    required this.id,
    required this.tugasFrasaId,
  ...
  factory JawabanTugas.fromJson(Map<String, dynamic> json) {
    return JawabanTugas(
      ...
      tugasFrasaId: _parseToInt(json['tugas_frasa_id']) ?? 0,
      ...
      tugasFrasa:
          json['tugas_frasa'] != null
              ? (json['tugas_frasa'] is Map
                  ? Map<String, dynamic>.from(json['tugas_frasa'])
                  : null)
              : null,
    );
  }
...
class JawabanFrasa extends StatefulWidget {
  const JawabanFrasa({Key? key}) : super(key: key);

  @override
  State<JawabanFrasa> createState() => _DataJawabanPageState();
}

class _DataJawabanPageState extends State<JawabanFrasa> {
  ...
  Future<List<JawabanTugas>> _fetchJawabanTugas() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
          'https://speakeasy-english.web.id/api/jawaban-frasas/user/$userId',
        ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Padding(
                            ...
                            child: Text(
                              'Anda belum mengerjakan tugas frasa apapun',
                              textAlign: TextAlign.center,
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final String tugasTitle =
                          jawaban.tugasFrasa != null
                              ? 'Tugas Frasa ${jawaban.tugasFrasa!['id']}'
                              : 'Tugas Frasa ${jawaban.tugasFrasaId}';
