...
class JawabanTugas {
  ...
  final Map<String, dynamic>? tugasKosakatas;

  JawabanTugas({
    required this.id,
    required this.tugasKosakatasId,
      ...
      tugasKosakatas:
          json['tugas_kosakatas'] != null
              ? (json['tugas_kosakatas'] is Map
                  ? Map<String, dynamic>.from(json['tugas_kosakatas'])
                  : null)
              : null,
    );
  }
...
class JawabanKosakatas extends StatefulWidget {
  const JawabanKosakatas({Key? key}) : super(key: key);

  @override
  State<JawabanKosakatas> createState() => _DataJawabanPageState();
}

class _DataJawabanPageState extends State<JawabanKosakatas> {
  ...
  Future<List<JawabanTugas>> _fetchJawabanTugas() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
          'https://speakeasy-english.web.id/api/jawaban-kosakatas/user/$userId',
        ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Padding(
                            ...
                            child: Text(
                              'Anda belum mengerjakan tugas kosakata apapun',
                              textAlign: TextAlign.center,
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final String tugasTitle =
                          jawaban.tugasKosakatas != null
                              ? 'Tugas Kosakata ${jawaban.tugasKosakatas!['id']}'
                              : 'Tugas Kosakata ${jawaban.tugasKosakatasId}';
  ...
  Future<void> _deleteJawabanTugas(int jawabanId) async {
    try {
      ...
      final response = await http.delete(
        Uri.parse(
          'https://speakeasy-english.web.id/api/jawaban-kosakatas/$jawabanId',
        ),
        headers: {
