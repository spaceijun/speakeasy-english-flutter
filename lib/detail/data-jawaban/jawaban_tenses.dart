...
class JawabanTugas {
  ...
  final Map<String, dynamic>? tugasTenses;
  ...
  factory JawabanTugas.fromJson(Map<String, dynamic> json) {
    return JawabanTugas(
      ...
      tugasTensesId: _parseToInt(json['tugas_tenses_id']) ?? 0,
      ...
      tugasTenses:
          json['tugas_tenses'] != null
              ? (json['tugas_tenses'] is Map
                  ? Map<String, dynamic>.from(json['tugas_tenses'])
                  : null)
              : null,
    );
  }
...
class JawabanTenses extends StatefulWidget {
  const JawabanTenses({Key? key}) : super(key: key);

  @override
  State<JawabanTenses> createState() => _JawabanTensesState();
}

class _JawabanTensesState extends State<JawabanTenses> {
  ...
  Future<List<JawabanTugas>> _fetchJawabanTugas() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
          'https://speakeasy-english.web.id/api/jawaban-tenses/user/$userId',
        ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Padding(
                            ...
                            child: Text(
                              'Anda belum mengerjakan tugas Tenses apapun',
                              textAlign: TextAlign.center,
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final String tugasTitle =
                          jawaban.tugasTenses != null
                              ? 'Tugas Tenses ${jawaban.tugasTenses!['id']}'
                              : 'Tugas Tenses ${jawaban.tugasTensesId}';
  ...
  Future<void> _deleteJawabanTugas(int jawabanId) async {
    try {
      ...
      final response = await http.delete(
        Uri.parse(
          'https://speakeasy-english.web.id/api/jawaban-tenses/$jawabanId',
        ),
        headers: {
